...
const teamData = [
  {
    ...
    description: [
      "Мастер спорта РФ",
      "Основатель клуба “TOP FIGHT” с более чем 20-летним опытом тренерской работы, он разработал уникальную методику, которая привела к успехам многих спортсменов. Настоящий наставник и друг, умеющий грамотно донести материал до учеников, создать дружелюбную атмосферу и привить любовь к спорту!",
    ],
  },
  {
    src: "/top-fight-gym/team/fedorenkov.jpg",
    ...
    description: [
      "Мастер спорта РФ",
      "Победитель первенства России по тайскому боксу.",
      "Серебряный призер первенства России по кикбоксингу",
      "Его внимание к деталям и умение находить общий язык со всеми возрастами помогут вам достичь любых поставленных целей.",
    ],
  },
  {
    src: "/top-fight-gym/team/fedorenkov.jpg",
